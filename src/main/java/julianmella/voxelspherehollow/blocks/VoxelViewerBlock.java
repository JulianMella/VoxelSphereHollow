...
public class VoxelViewerBlock {
    ...
    public static void initialize() {
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.FUNCTIONAL).register((itemGroup) -> {
            itemGroup.add(VoxelViewerBlock.PARSER_BLOCK.asItem());
        });
    }
    ...
    private static RegistryKey<Block> keyOfBlock(String name) {
        return RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(VoxelSphereHollow.MOD_ID, name));
    }

    private static RegistryKey<Item> keyOfItem(String name) {
        return RegistryKey.of(RegistryKeys.ITEM, Identifier.of(VoxelSphereHollow.MOD_ID, name));
    }
}